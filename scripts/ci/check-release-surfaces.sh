...
grep -q "npm install -g @luoyuctl/agenttrace" README.md ||
	fail "README must document npm installation"
grep -q "npm install -g @luoyuctl/agenttrace" README.zh-CN.md ||
	fail "README.zh-CN must document npm installation"
grep -q '"name": "@luoyuctl/agenttrace"' npm/package.json ||
	fail "npm package must use the @luoyuctl/agenttrace name"
