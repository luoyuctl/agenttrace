...
var translations = map[string]map[Lang]string{
	...
	"keymap_subtitle":       {EN: "Fast paths for triage, filters, diagnostics, and cache-aware reloads.", ZH: "用于快速排查、筛选、诊断和缓存重载的常用操作。"},
	...
	"keymap_jump":           {EN: "jump to a view", ZH: "跳转到视图"},
	"keymap_next":           {EN: "next view", ZH: "下一个视图"},
	"keymap_back":           {EN: "back or close", ZH: "返回或关闭"},
	"keymap_select":         {EN: "select session", ZH: "选择会话"},
	"keymap_enter":          {EN: "open selected detail", ZH: "打开选中详情"},
	"keymap_diag":           {EN: "open diagnostics", ZH: "打开诊断"},
	"keymap_diff":           {EN: "compare nearby sessions", ZH: "对比相邻会话"},
	"keymap_search":         {EN: "text search", ZH: "文本搜索"},
	...
	"keymap_reload":         {EN: "reload with cache", ZH: "使用缓存重载"},
	"keymap_force_reload":   {EN: "force cache rebuild", ZH: "强制重建缓存"},
	"keymap_lang":           {EN: "toggle language", ZH: "切换语言"},
