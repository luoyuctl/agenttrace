...
var translations = map[string]map[Lang]string{
	...
	"cmd_usage_top":        {EN: "usage: top cost|health|turns", ZH: "用法: top cost|health|turns"},
	"cmd_usage_sort":       {EN: "usage: sort cost|health|turns|name [asc|desc]", ZH: "用法: sort cost|health|turns|name [asc|desc]"},
	...
	"waste_level_green":       {EN: "green", ZH: "绿色"},
	"waste_level_yellow":      {EN: "yellow", ZH: "黄色"},
	"waste_level_orange":      {EN: "orange", ZH: "橙色"},
	"waste_level_red":         {EN: "red", ZH: "红色"},
